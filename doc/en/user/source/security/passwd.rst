...
.. warning:: The file ``security/masterpw.info`` is a security risk. The administrator should read this file and verify the keystore password by logging into GeoServer as the ``root`` user. On success, this file should be removed.
