...
public class MigrateKeystore {
    ...
    public static void main(String[] args) {
        ...
        options.addOption("spr", "source-provider", true, "Source keystore provider (default: auto-detect)");
        options.addOption("tt", "target-type", true, "Target keystore type (default: BCFKS)");
        options.addOption("tpr", "target-provider", true, "Target keystore provider (default: auto-detect)");
