 ...
 *
 * <p>Repeatable also means that two URLs sharing a 16 byte aligned prefix share the encrypted prefix, and that a
 * repeated URL is recognizable as such; this protects parameters from tampering by a casual observer, not their
 * confidentiality. Same design as GeoServer upstream.
 */
