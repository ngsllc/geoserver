                ...
                if (provider != null && java.security.Security.getProvider(provider) == null) {
                    ...
                    try {
                        if (BCFIPS_PROVIDER.equals(provider)) {
                            ...
                            // Try to register regular BouncyCastle provider
                            Class<?> providerClass =
                        ...
                        LOGGER.warning("Failed to register BouncyCastle provider: " + e.getMessage());
                        // Continue without the provider - it might already be registered
                    }
                }
            }
